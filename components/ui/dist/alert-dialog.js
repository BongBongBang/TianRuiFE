...
var AlertDialogOverlay = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(AlertDialogPrimitive.Overlay, __assign({ className: utils_1.cn('fixed inset-0 z-50 bg-background/80 backdrop-blur-sm data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0', className) }, props, { ref: ref })));
});
